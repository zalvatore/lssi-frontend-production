...
class ComisionVentaForm extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <h5>Ingresos: {estudiantesIngreso?.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h5>
        <Form onSubmit={this.props.admin ? this.editAdmin : this.createAdmin}>
          <FormGroup>
            <Label for="admin_del_curso">Vendedor:</Label>
            <Input
              type="select"
            ...
            >
              <option key='0' value="">Vendedor:</option>
          ...
          <FormGroup>
            <Label for="costo">Comision:</Label>
...
export default ComisionVentaForm;
